...
class BatchSelectionPage extends GetView<BatchSelectionController> {
  ...
  //         //   child: CustomPaint(
  //         //     painter: ParticleAnimation(particles: controller.particles),
  //         //   ),
  //         // ),
  ...
  // // RoundedRectangleBorder get noRadius =>
  ...
  // Widget title(BuildContext context, String title) => SizedBox(
  //       width: double.maxFinite,
  //       child: Padding(
...
// class ParticleAnimation extends CustomPainter {
//   final List<Particle> particles;

//   ParticleAnimation({required this.particles});
